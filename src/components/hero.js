				...
				<div className='container__hero--secondary container--secondary'>
					<Container className='container--primary'>
						<Left className='hero__left'>
							...
							<Author> Kasymjaparov Adilet</Author>
						...
						<Image className='decoration decoration__cross' src={cross} alt='cross' loading='lazy' />
						<Image className='decoration decoration__tick' src={tick} alt='tick' loading='lazy' />
						<Image className='decoration decoration__circle' src={circle} alt='circle' loading='lazy' />
					</Container>
				</div>
			</HeroContainer>
		</HeroSection>
